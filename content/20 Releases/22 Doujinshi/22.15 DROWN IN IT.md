...
This translation was commissioned by Nirvashzero.
...
This is also the first Kancolle doujinshi we worked on. Shame that the raws available was quite awful to work on. I used waifu2x (specifically, unlimited:waifu2x, which is newer version; small and fast, too!), but looking back at it, I might've gone too far with it; some details are lost and I only noticed it when editing the pages. Sorry about that.
