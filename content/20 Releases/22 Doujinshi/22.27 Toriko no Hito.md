...
`(C107) [Shiro no Ie (Yochiki)] TORIKO NO HITO | CAPTIVE [English] [Pinandhita 論理型]`
...
We probably need to work on our tardy translation pace at this point. One of the reason the commission is closed for now, and one of the book we're doing is quite long, the longest we've done so far.
